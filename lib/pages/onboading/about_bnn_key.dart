...
/// アプリ
class AboutBnnKey extends HookConsumerWidget {
  const AboutBnnKey({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final nextPageButton = FloatingActionButton.extended(
      onPressed: () {
        onboardingRouter.push(OnboardingPageId.receiveStartBonus);
      },
